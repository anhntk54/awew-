...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 25, 2014 at 01:18 PM
...
INSERT INTO `users` (`username`, `email`, `password`, `fullName`, `roles`, `lastAccessTime`, `lastIPAccess`, `isBlock`, `createDate`, `createBy`, `avatar`, `id`, `phone`, `score`) VALUES
('tocoti', 'minhtienuet@gmail.com', '$2a$13$r2reRavbkOJZV3/SW5psDuBxg1jtN73K2YpRlRtRwke/e4P2CjLCW', 'Loving Rape', 'admin', NULL, NULL, 0, NULL, 0, '1381659071-1924-499x352.jpg', 17, 1689935018, 0),
('member', 'tongcongtien@gmail.com', '$2a$13$LbiKsPv8Sw84jfcs5Ir12uG66ifVybKGpkGEC7Jh1DoQhHxHWKWPO', 'Tống công Tiến', 'member', NULL, NULL, 0, '2013-10-14 16:58:13', 0, NULL, 18, NULL, 0),
('trieunhu', 'anhntk54@gmail.com', '$2a$13$r2reRavbkOJZV3/SW5psDuBxg1jtN73K2YpRlRtRwke/e4P2CjLCW', 'Nhữ Tuấn anh', 'admin', NULL, NULL, 0, '2014-02-11 12:25:20', 0, NULL, 19, NULL, 0);
